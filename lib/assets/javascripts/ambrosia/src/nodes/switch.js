(function() {
  ...
  exports.Switch = Switch = (function(_super) {
    ...
    Switch.prototype.prepare = function() {
      var If, Operation, closure, condition, invocation, method_call, new_if, _i, _if, _j, _len, _len2, _ref, _ref2, _when;
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        method_call = this.create(MethodCall, this.create(Identifier, closure.getID()), []);
        method_call.push_stack = false;
        _ref2 = _when[0];
        for (_j = 0, _len2 = _ref2.length; _j < _len2; _j++) {
          condition = _ref2[_j];
          invocation = this.create(Block, [method_call]);
    ...
    Switch.prototype.compile = function(b) {
      var closure, current_screen, result, _i, _len, _ref;
      this.assign(b, this.actual_value, this.expression);
      current_screen = b.root.current_screen();
      result = this._if.compile(b.root.current_screen());
      current_screen = b.root.current_screen();
      _ref = this.closures;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        closure = _ref[_i];
