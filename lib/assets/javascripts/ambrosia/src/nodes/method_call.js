(function() {
  ...
  exports.MethodCall = MethodCall = (function(_super) {
    ...
    function MethodCall() {
      ...
      this.push_stack = true;
      MethodCall.__super__.constructor.apply(this, args);
    }
    ...
    MethodCall.prototype.run_prepare_blocks = function() {
      var param, _i, _len, _ref, _results;
      MethodCall.__super__.run_prepare_blocks.call(this);
      _ref = this.params;
      _results = [];
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        param = _ref[_i];
        _results.push(param.run_prepare_blocks());
      }
      return _results;
    };
    ...
    MethodCall.prototype.compile = function(builder) {
      var Assign, Identifier, Literal, dest, function_screen_id, i, match, method, param, param_list, param_name, param_type, return_screen_id, screen, v, variable, _ref;
      ...
      screen.root.current_screen().call_method(function_screen_id, return_screen_id, this.push_stack);
