(function() {
  ...
  exports.Builder = Builder = (function() {
    ...
    Builder.prototype.make_root = function() {
    ...
    Builder.prototype.set_root = function(root) {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        tag = _ref[_i];
        _results.push(tag.set_root(root));
      }
      return _results;
    };
    ...
    Builder.prototype.reorder = function() {
      ...
      sort = function(a, b) {
        ...
        if (ai === -1) {
          throw new Error("child not listed for reorder: '" + a.name + "' (parent: '" + _this.name + "')");
        }
        if (bi === -1) {
          throw new Error("child not listed for reorder: '" + b.name + "' (parent: '" + _this.name + "')");
        }
        if (ai <= bi) {
          return [a, b];
        } else {
    ...
    Builder.prototype.stringify = function() {
      ...
      if (this.tags.length > 0 || this.force_endtag) {
