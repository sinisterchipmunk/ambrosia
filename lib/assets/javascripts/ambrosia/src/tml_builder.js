(function() {
  ...
  Builder.screen = Screen = (function(_super) {
    ...
    Screen.prototype.toString = function() {
      if (!(this.first('next') || !this.attrs.next)) {
        this.b('next', {
          uri: this.attrs.next
        });
        delete this.attrs.next;
      }
      return Screen.__super__.toString.call(this, false);
    };
    ...
    Screen.prototype.branch = function(operation) {
      var base_id, new_screen_id, new_screen_uri, next, scr, _ref;
      if (!(next = this.first('next'))) {
        next = this.b('next', {
          uri: this.attrs.next
        });
      ...
      if (operation.key && ((_ref = operation.key) === 'cancel')) {
        this.attrs.cancel = operation.uri;
      } else {
