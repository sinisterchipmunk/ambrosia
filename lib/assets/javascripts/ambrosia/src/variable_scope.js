(function() {
  ...
  exports.VariableScope = Scope = (function() {
    ...
    function Scope(prefix, parent) {
      ...
      if (!this.parent) {
        for (name in Builtins) {
          default_value = Builtins[name];
          type = (typeof default_value === 'string' ? 'string' : 'integer');
          this.builtin[name] = new Variable(name, type);
        }
      }
    }
    ...
    Scope.prototype.find = function(name, downward) {
      var def, localname, prefix, scope, variable, _name, _ref, _ref2, _ref3;
      ...
      if (!this.parent) {
        _ref2 = this.builtin;
        for (_name in _ref2) {
          variable = _ref2[_name];
          if (_name === name) return variable;
        }
      }
      _ref3 = this.subscopes;
      for (prefix in _ref3) {
        scope = _ref3[prefix];
