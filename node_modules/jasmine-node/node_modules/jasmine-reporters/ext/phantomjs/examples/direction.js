(function() {
  var dest, ins, origin, steps, _i, _len;
  if (phantom.state.length === 0) {
    ...
    phantom.open(encodeURI('http://maps.googleapis.com/maps/api/directions/xml?origin=' + origin + '&destination=' + dest + '&units=imperial&mode=driving&sensor=false'));
  } else {
