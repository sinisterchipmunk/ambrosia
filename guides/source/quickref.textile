...
WARNING: This scripting language is under heavy development. It is **NOT** considered a stable release. If you encounter an error and suspect it may be a bug originating within the framework itself, you can run the compiler with the +DEBUG+ environment variable set. This will dump internal information to standard output and may help track down the source of the error.
